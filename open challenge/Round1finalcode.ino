...
// Constants
const int MOTOR_SPEED = 180;  // PWM speed
const int SLOW_SPEED = 120;  // Reduced speed for turns
const float SIDE_TURN_DISTANCE = 100; // Side sensor trigger (cm)
...
const float KW = 2.0;         // Inner wall-following gain
