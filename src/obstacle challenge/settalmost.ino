...
const int TOTAL_EDGES = 12;   // 4 corners * 3 laps + 1
...
const float OUTER_WALL_THRESHOLD = 25; // Outer wall crash threshold (cm)
...
void performTurn(bool clockwise) {
  ...
  float turnTarget = startAngle + (clockwise ? -87 : 87);
